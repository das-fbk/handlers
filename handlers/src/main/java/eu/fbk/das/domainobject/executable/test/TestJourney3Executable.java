...
public class TestJourney3Executable extends AbstractExecutableActivityInterface {

	private static final Logger logger = LogManager
			.getLogger(TestJourney3Executable.class);
	...
	public TestJourney3Executable(ProcessEngine processEngine) {
