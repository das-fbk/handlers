...
public class BBCServiceCallExecutable extends
	...
	private ArrayList<TripAlternativeBlaBlaCar> blaBlaCarAlternatives;
	...
	public void execute(ProcessDiagram proc, ProcessActivity pa) {
		...
		if (doiState != null) {
			...
			blaBlaCarAlternatives = blablaWrapper.getBlaBlaCarAlternatives(
					sourceValue, destinationValue, serviceExecTime);

			pe.setTestServicesLog(user.getId(), "BlaBlaCar",
					serviceExecTime.get(0), blaBlaCarAlternatives.size(), 0);
