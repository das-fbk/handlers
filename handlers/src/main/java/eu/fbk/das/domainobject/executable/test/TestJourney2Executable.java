...
public class TestJourney2Executable extends AbstractExecutableActivityInterface {

	private static final Logger logger = LogManager
			.getLogger(TestJourney2Executable.class);
	...
	public TestJourney2Executable(ProcessEngine processEngine) {
